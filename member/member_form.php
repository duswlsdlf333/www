	...
	<article id="content">  
     ...
     <ul>
         <li>
              ...
              <input type="text" name="id" id="id" placeholder="아이디를 입력해주세요.(영문/숫자만 가능)" required onkeyup="check_input2()" >
         ...
         <li>
              ...
              <input type="password" name="pass_confirm" id="pass_confirm" placeholder="비밀번호를 확인해주세요." required>
         </li>
         <li>
         ...
         <li>
              ...
              <input type="text" class="hp" name="hp2" id="hp2"  required> - <label class="hidden" for="hp3">전화번호끝4자리</label>
         ...
         <li class="end">
             <ul>
                 <li>
                     <a href="#" class="join_end" onclick="check_input()">가입완료</a>
                 </li>
                 <li>
