<? 
	...
	$table = "news"; // 해당 게시판의 테이블의 명을 담아놓고 쓴다.
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<article id="content">
	...
	<div class="content_area">          
		...
		<div id="list_search">					
			...
			<div id="list_search5"><input type="image" src="../images/search.png"></div>
		</div>
		</form>
...
<?		
   for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)                    
   {
      ...
      if ($len_subject > $char_limit)
      {
        ...
        $item_subject = mb_substr($item_subject, 0, $char_limit, 'utf-8');
      ...
      if($row[file_copied_0]){ // 첫번째 첨부 이미지가 있으면
        $item_img = './data/'.$row[file_copied_0];  
          //  ./data/2020_10_12_10_40_59_0.jpg 
      }else{   // 첨부된 이미지가 없으면...
...
?>
			<div id="list_item">
                    ...
                    <a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>">				
                        ...
                        <span class="dat"><?= $item_date ?></span>
                        <p><?= $item_subject ?></p>
                        <span class="hit"><?= $item_hit ?></span>
                    </a>
                    </div>	
			</div>
<?
...
<? 
	if($userid=="duswlsdlf333")     // $userid=='duswlsdlf333' 관리자에게만 쓰기, 수정으로 할 때
	{
?>
